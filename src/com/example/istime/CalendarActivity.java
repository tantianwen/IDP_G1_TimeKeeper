...
public class CalendarActivity extends FragmentActivity implements
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			switch (position) {
			case 0:
				return getString(R.string.Week_Section).toUpperCase(l);
			case 1:
				return getString(R.string.Month_Section).toUpperCase(l);
			case 2:
				return getString(R.string.Year_Section).toUpperCase(l);
			}
			return null;
		}
	}
